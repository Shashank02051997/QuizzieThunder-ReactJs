...
const ShowQuizDetails = () => {
    ...
    const getQuizDetail = async (data) => {
        ...
        try {
            ...
            const response = await axios.get(`${base_url}/quiz/${state.quiz._id}`, { headers });
                        ...
                        <div className="py-8 px-4 mx-auto ">
                            ...
                            <div className="w-full flex flex-row mb-1">
                                <div className="w-full flex flex-col">
                                    ...
                                    <p className="mb-4 font-medium text-gray-600 flex flex-row space-x-2 items-center">{quizResult.description}</p>
                                </div>
                            </div>

                            <div className="flex flex-row space-x-4 mt-8">
                                <button onClick={() => openEditQuiz(quizResult)} type="button" className="text-white inline-flex items-center bg-primary-700 hover:bg-primary-800 focus:ring-4 focus:outline-none focus:ring-primary-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-primary-600 dark:hover:bg-primary-700 dark:focus:ring-primary-800">
