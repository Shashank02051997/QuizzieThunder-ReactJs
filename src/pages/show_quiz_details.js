...
const ShowQuizDetails = () => {
    ...
    const openQuestionList = (quiz) => {
        navigate("/admin/questions", { state: { "quiz": quiz } });
    };
                        ...
                        <div className="py-8 px-4 mx-auto ">
                            ...
                            <div className="w-full flex flex-row mb-1">
                                <div className="w-full flex flex-col">
                                    ...
                                    <button button type="button" onClick={() => openQuestionList(quizResult)} className="mb-4 font-medium text-gray-600 flex flex-row space-x-2 items-center hover:text-primary-700">{quizResult.title}</button>
                                </div>
                            </div>
