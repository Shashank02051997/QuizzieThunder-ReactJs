                            ...
                            <div className="bg-white relative shadow-md sm:rounded-lg overflow-hidden">
                                ...
                                <div className="overflow-x-auto">
                                    <table className="w-full text-sm text-left text-gray-500">
                                        ...
                                        <tbody>
                                            {userListResult.map((admin, index) => (
                                                <tr key={admin._id} className="border-b relative">
                                                    ...
                                                    <td className="px-4 py-3 relative">
                                                        ...
                                                        {/* Drop down */}
                                                        <div ref={rowDropdownRef} id={`apple-imac-27-dropdown-${admin._id}`} className={`z-10 w-44 bg-white rounded divide-y divide-gray-100 shadow absolute right-0 ${activeDropdown === admin._id ? 'block' : 'hidden'} ${index >= userListResult.length - 2 ? '-top-28' : 'top-10'}`}
                                                        >
