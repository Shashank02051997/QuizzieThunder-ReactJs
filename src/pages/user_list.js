...
const UserList = () => {
    return (
        <>
            {/*<!-- Start block -->*/}
            <section className="bg-gray-50 dark:bg-gray-900 p-3 sm:p-5 antialiased mt-10">
                <div className="flex flex-col md:flex-row items-center justify-between space-y-3 md:space-y-0 md:space-x-4 p-4">
                    <h1 className="text-3xl font-medium">List</h1>
                            ...
                            <table className="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                                <thead className="text-xs text-gray-700 uppercase bg-gray-50 dark:bg-gray-700 dark:text-gray-400">
                                    <tr>
                                        ...
                                        <th scope="col" className="px-4 py-3">Mobile Number Verified</th>
                                ...
                                <tbody>
                                    <tr className="border-b dark:border-gray-700">
                                        <th scope="row" className="px-4 py-3 font-medium text-gray-900 whitespace-nowrap dark:text-white max-w-[10rem] truncate">71d50386c2d13cd087a10e3a</th>
                                        <td className="px-4 py-3">Aman Goyal</td>
                                        <td className="px-4 py-3 max-w-[15rem] truncate">aman@gmail.com</td>
                                        <td className="px-4 py-3">8987678908</td>
                                    ...
                                    <tr className="border-b dark:border-gray-700">
                                        <th scope="row" className="px-4 py-3 font-medium text-gray-900 whitespace-nowrap dark:text-white max-w-[10rem] truncate">66ad50386c2d13cd087a10e31</th>
                                        <td className="px-4 py-3">Muskan Goyal</td>
                                        <td className="px-4 py-3 max-w-[15rem] truncate">muskan@gmail.com</td>
                                        <td className="px-4 py-3">7987678909</td>
                                        <td className="px-4 py-3">Yes</td>
                                        <td className="px-4 py-3 flex items-center justify-end">
