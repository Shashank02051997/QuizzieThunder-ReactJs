                                            ...
                                            {userListResult.map((admin, index) => (
                                                <tr key={admin._id} className="border-b relative">
                                                    ...
                                                    <td className="px-4 py-3 relative">
                                                        ...
                                                        {/* Drop down */}
                                                        <div id={`apple-imac-27-dropdown-${admin._id}`} className={`z-10 w-44 bg-white rounded divide-y divide-gray-100 shadow absolute right-0 ${dropdownVisibility[admin._id] ? 'block' : 'hidden'} ${index >= userListResult.length - 2 ? '-top-20' : 'top-10'}`}
                                                        >
