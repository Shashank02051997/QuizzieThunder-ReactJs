                                        ...
                                        <tbody>
                                            {quizCategoryListResult.map((quizCategory, index) => (
                                                <tr key={quizCategory._id} className="border-b relative">
                                                    <th type="button" onClick={() => openQuizCategoryPreview(quizCategory)} className="px-4 py-3 font-medium text-gray-900 whitespace-nowrap max-w-[10rem] truncate hover:text-primary-700">{quizCategory._id}</th>
